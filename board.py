...
with tf.Session() as sess:
    ...
    summary_writer = tf.summary.FileWriter('C:\\Users\\Pulkit\\AppData\\Local\\Programs\\Python\\Python36\\Lib\\site-packages\\tensorflow\\python\\summary\\writer', graph=sess.graph)
